...
class Kohana_Core {
	 ...
	 *
         * JME:
         * Provedl jsem uprav, ktera na konec zpravy, ktera je do logu prida
         * navratovou hodnotu funkce debug_backtrace(), zeserializovanou a v base64.
         *
         *
	...
	public static function exception_text(Throwable $e)
	{
		return sprintf('%s [ %s ] [ %s , %s ] [ %s -> %s ]: %s ~ %s [ %d ] (Callstack: %s)',
			get_class($e), 
                        ...
                        Kohana::debug_path($e->getFile()),
                        $e->getLine(),
                        'n/a'/*base64_encode(serialize(debug_backtrace()))*/);
	}
