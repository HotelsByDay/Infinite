...
<?php $error_id = uniqid('error');?>
  <style type="text/css">
    #ptb_err{font-size: 10pt; font-family:sans-serif; text-align: left; color: #ccc; margin-top: 30px;}
    ...
    #ptb_err .content ol.trace li table.arguments td {border: 1px solid #252424;color: #ccc;padding: 3px;text-align: left;vertical-align: top;}
