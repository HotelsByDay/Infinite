 ...
 *
 * POZOR - custom upravy:
 * 1) z-index byl nastaven na hodnotu 1003 (puvodne 1000)
 * 2) option 'theme' nastaven na true aby plugin spolupracoval s jQuery theme
...
$.blockUI.defaults = {
	...
	message:  '<span class="blockUI_message"><?= __("general.loading_table_data");?></span>',
...
function install(el, opts) {
	...
	if (opts.theme && full) {
		s = '<div class="blockUI ' + opts.blockMsgClass + ' blockPage ui-dialog ui-widget ui-corner-all" style="z-index:'+z+';display:none;position:fixed">' +
            ...
            //ui-widget-header ui-dialog-titlebar ui-corner-all
            //				'<div class=" blockTitle">'+(opts.title || '&nbsp;')+'</div>' +
		s = '<div class="blockUI ' + opts.blockMsgClass + ' blockElement ui-dialog ui-widget ui-corner-all" style="z-index:'+z+';min-width:'+themedCSS.minWidth+'px;display:none;position:absolute">' +
