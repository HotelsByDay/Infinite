...
var Button_sb = function (element, options) {
this.$element = $(element)
this.options = $.extend({}, $.fn.button_sb.defaults, options)
}

Button_sb.prototype.setState = function (state) {
var d = 'disabled'
, $el = this.$element
, data = $el.data()
...
Button_sb.prototype.toggle = function () {
...
$.fn.button_sb = function (option) {
return this.each(function () {
var $this = $(this)
, data = $this.data('button')
, options = typeof option == 'object' && option
if (!data) $this.data('button', (data = new Button_sb(this, options)))
if (option == 'toggle') data.toggle()
else if (option) data.setState(option)
})
}

$.fn.button_sb.defaults = {
loadingText: 'loading...'
}

$.fn.button_sb.Constructor = Button_sb
