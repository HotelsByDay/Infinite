...
class Controller_Logs extends Controller {
    ...
    function before()
    {
        ...
        $this->_year = (int)$this->request->param('year');
        // Tady dochazelo k problemu ze request->param vracelo misto roku 'index'
        // - tatko kontrola tuto situaci osetruje
        if (empty($this->_year)) {
            $this->_year = Date('Y');
        }
