  ...
  protected $view;
	...
	public function before() {
		...
		try {
			...
			echo 'Flexible Migrations is not installed. Please Run the migrations.sql script in your mysql server - '.$a->getMessage();
			exit();
		}
	...
	public function action_create() {
		...
		try {
      if (empty($migration_name)) { throw new Exception("Migration mame must not be empty"); }
